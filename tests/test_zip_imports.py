...
def test_load_config_from_env_file_gracefully_handles_zip_imports_when_no_env_file(tmp_path):
...
def test_load_config_from_env_file_outside_zip_file_when_called_in_zipfile(tmp_path):
    zip_file_path = setup_zipfile(
        tmp_path,
        [
            FileToAdd(
